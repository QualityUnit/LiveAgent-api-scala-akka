...
class BansApi(baseUrl: String) {
   ...
   * @param ban 
   */
  def createBan(ban: Option[Ban] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Ban] =
   ...
   * @param banId 
   */
  def expireBan(banId: Int)(implicit apiKey: ApiKeyValue): ApiRequest[Ban] =
   ...
   * @param banId 
   */
  def getBan(banId: Int)(implicit apiKey: ApiKeyValue): ApiRequest[Ban] =
   ...
   */
  def getBans(page: Option[Int] = None, perPage: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None, from: Option[Int] = None, to: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[BanListItem]] =
   ...
   * @param ban 
   */
  def updateBan(banId: Int, ban: Option[Ban] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Ban] =
