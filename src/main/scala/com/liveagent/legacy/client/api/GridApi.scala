...
class GridApi(baseUrl: String) {
   ...
   */
  def getCallsSlaLogGridList(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None, timezoneOffset: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[SlaLogRow]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getCallsSlaLogGridListCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   * @param timezoneOffset difference between client and server time in seconds
   */
  def getChatsSlaLogGridList(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None, timezoneOffset: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[SlaLogRow]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getChatsSlaLogGridListCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   * @param timezoneOffset difference between client and server time in seconds
   */
  def getEventLogsGridList(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None, timezoneOffset: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[EventLogRow]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getEventLogsGridListCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   * @param timezoneOffset difference between client and server time in seconds
   */
  def getTicketsGridList(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None, timezoneOffset: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[TicketRow]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getTicketsGridListCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   * @param timezoneOffset difference between client and server time in seconds
   */
  def getTicketsSlaLogGridList(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None, timezoneOffset: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[SlaLogRow]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getTicketsSlaLogGridListCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
