...
class ApiApi(baseUrl: String) {
   ...
   * @param apiKey 
   */
  def createApiKeys(apiKeyWithPrivileges: Option[ApiKeyWithPrivileges] = None)(implicit apiKey: ApiKeyValue): ApiRequest[ApiKeyWithPrivileges] =
   ...
   * @param apikeyId 
   */
  def deleteApiKey(apikeyId: Double)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   *   apikey (apiKey)
   */
  def generateApiKey()(implicit apiKey: ApiKeyValue): ApiRequest[ApiKey] =
   ...
   */
  def getApiInfo(apiVersion: String)(implicit apiKey: ApiKeyValue): ApiRequest[ApiInfo] =
   ...
   * @param apikeyId 
   */
  def getApiKey(apikeyId: Double)(implicit apiKey: ApiKeyValue): ApiRequest[ApiKeyWithPrivileges] =
   ...
   * @param sortField 
   */
  def getApiKeys(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[ApiKey]] =
   ...
   *   apikey (apiKey)
   */
  def getApiPrivileges()(implicit apiKey: ApiKeyValue): ApiRequest[Seq[ApiPrivilege]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getApiV3KeysCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   * @param apiKey 
   */
  def updateApiKey(apikeyId: Double, apiKeyWithPrivileges: Option[ApiKeyWithPrivileges] = None)(implicit apiKey: ApiKeyValue): ApiRequest[ApiKeyWithPrivileges] =
