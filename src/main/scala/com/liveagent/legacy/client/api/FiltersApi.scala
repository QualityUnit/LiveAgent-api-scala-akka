...
class FiltersApi(baseUrl: String) {
   ...
   * @param filter 
   */
  def createFilter(filter: Option[Filter] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Filter] =
   ...
   * @param filterId 
   */
  def deleteFilter(filterId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param filterId 
   */
  def getFilter(filterId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Filter] =
   ...
   */
  def getFilters(page: Option[Int] = None, perPage: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None, from: Option[Int] = None, to: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Filter]] =
   ...
   * @param filter 
   */
  def updateFilter(filterId: String, filter: Option[Filter] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Filter] =
