...
import com.liveagent.legacy.client.model.HostingInfo
...
object HostingApi {
  ...
  def apply(baseUrl: String = "https://localhost/api/v3") = new HostingApi(baseUrl)
}
...
class HostingApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : HostingInfo (Hosting info)
   *   code 0 : ErrorResponse (Error response)
   */
  def getInfo(): ApiRequest[HostingInfo] =
    ApiRequest[HostingInfo](ApiMethods.GET, baseUrl, "/hosting/info", "application/json")
      .withSuccessResponse[HostingInfo](200)
