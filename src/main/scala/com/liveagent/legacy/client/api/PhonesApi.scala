...
class PhonesApi(baseUrl: String) {
   ...
   * @param name 
   */
  def createPhone(number: String, `type`: Option[String] = None, name: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[PhoneDevice] =
   ...
   * @param phoneId 
   */
  def getPhone(phoneId: String)(implicit apiKey: ApiKeyValue): ApiRequest[PhoneDevice] =
   ...
   */
  def getPhonesList(page: Option[Int] = None, perPage: Option[Int] = None, from: Option[Int] = None, to: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[PhoneDevice]] =
   ...
   * @param phoneId 
   */
  def removePhone(phoneId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param name 
   */
  def updatePhone(phoneId: String, name: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[PhoneDevice] =
   ...
   */
  def updatePhoneParams(phoneId: String, params: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
