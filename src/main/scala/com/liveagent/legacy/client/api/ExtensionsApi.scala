...
class ExtensionsApi(baseUrl: String) {
   ...
   * @param extensionId 
   */
  def getExtension(extensionId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Extension] =
   ...
   */
  def getExtensionsCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   */
  def getExtensionsList(perPage: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Extension]] =
   ...
   */
  def setExtension(extensionId: String, number: Option[String] = None, departmentId: Option[String] = None, status: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Extension] =
