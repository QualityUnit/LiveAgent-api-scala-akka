...
object MicroservicesGmailApi {

  def apply(baseUrl: String = "https://localhost/api/v3") = new MicroservicesGmailApi(baseUrl)
}
...
class MicroservicesGmailApi(baseUrl: String) {
   ...
   * @param emailAddress 
   */
  def activateGmailAccount(gmailAccountId: String, emailAddress: EmailAddressObj)(implicit apiKeyValueFromRequest: ApiKeyValueFromRequest): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.POST, baseUrl, "/gmail_accounts/{gmailAccountId}/_activate", "application/json")
   ...
   * @param gmailAccountId 
   */
  def deactivateGmailAccount(gmailAccountId: String)(implicit apiKeyValueFromRequest: ApiKeyValueFromRequest): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.POST, baseUrl, "/gmail_accounts/{gmailAccountId}/_deactivate", "application/json")
      .withApiKey(apiKeyValueFromRequest, "apikey", HEADER)
      .withPathParam("gmailAccountId", gmailAccountId)
      .withSuccessResponse[Any](200)
      .withErrorResponse[ErrorResponse](404)
   ...
   * @param gmailAccountId 
   */
  def deleteGmailAccount(gmailAccountId: String)(implicit apiKeyValueFromRequest: ApiKeyValueFromRequest): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.DELETE, baseUrl, "/gmail_accounts/{gmailAccountId}", "application/json")
      .withApiKey(apiKeyValueFromRequest, "apikey", HEADER)
      .withPathParam("gmailAccountId", gmailAccountId)
      .withSuccessResponse[Any](200)
      .withErrorResponse[ErrorResponse](404)
   ...
   * @param reason 
   */
  def rejectGmailAccount(gmailAccountId: String, reason: ErrorResponse)(implicit apiKeyValueFromRequest: ApiKeyValueFromRequest): ApiRequest[Any] =
    ApiRequest[Any](ApiMethods.POST, baseUrl, "/gmail_accounts/{gmailAccountId}/_reject", "application/json")
      .withApiKey(apiKeyValueFromRequest, "apikey", HEADER)
      .withBody(reason)
      .withPathParam("gmailAccountId", gmailAccountId)
      .withSuccessResponse[Any](200)
