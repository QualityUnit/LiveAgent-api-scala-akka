...
import com.liveagent.legacy.client.model.Token
...
object TokenApi {
  ...
  def apply(baseUrl: String = "https://localhost/api/v3") = new TokenApi(baseUrl)
}
...
class TokenApi(baseUrl: String) {
   ...
   */
  def getAccessToken(username: String, password: String)(implicit apiKeyValueFromRequest: ApiKeyValueFromRequest): ApiRequest[Token] =
