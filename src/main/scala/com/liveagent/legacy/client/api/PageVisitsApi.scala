...
class PageVisitsApi(baseUrl: String) {
   ...
   */
  def getPageVisitByContactId(contactId: String, sortDir: Option[String] = None, sortField: Option[String] = None, page: Option[Int] = None, perPage: Option[Int] = None, from: Option[Int] = None, to: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[PageVisit]] =
