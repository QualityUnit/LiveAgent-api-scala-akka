...
class CallsApi(baseUrl: String) {
   ...
   * @param body 
   */
  def callAddMessage(callId: String, body: Option[CallMessage] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param file 
   */
  def callAddRecording(callId: String, file: Option[File] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def callAnswer(callId: String, toNumber: String, channelId: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def callChangeChannelStatus(callId: String, channelId: String, status: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def callCreate(callId: String, toNumber: String, fromNumber: String, channelId: Option[String] = None, viaNumber: Option[String] = None, ticketId: Option[String] = None, direction: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Call] =
   ...
   * @param fetch 
   */
  def callFetchIvr(callId: String, fetch: IvrFetch)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Ivr]] =
   ...
   */
  def callGetStatus(callId: String, unreachableAgents: Seq[String])(implicit apiKey: ApiKeyValue): ApiRequest[CallStatus] =
   ...
   */
  def callMoveChannel(callId: String, channelId: String, toCallId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param channelId 
   */
  def callRemoveChannel(callId: String, channelId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param unreachableAgents Identifiers of unreachable agents that should be excluded from routing
   */
  def callReroute(callId: String, reason: Option[String] = None, unreachableAgents: Seq[String])(implicit apiKey: ApiKeyValue): ApiRequest[CallStatus] =
   ...
   * @param toNumber callee number
   */
  def callRing(callId: String, departmentId: Option[String] = None, toNumber: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[CallStatus] =
   ...
   */
  def callStart(toNumber: String, fromNumber: String, ticketId: String, viaNumber: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def callStartCanceled(callId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param callId Call ID
   */
  def callStartFailed(callId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def callStop(callId: String, fromNumber: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def callTransfer(callId: String, to: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[CallTransferResult] =
   ...
   * @param channelId Channel ID
   */
  def confirmRing(callId: String, toNumber: Option[String] = None, channelId: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def dtmfChannel(callId: String, channelId: String, dtmf: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param channelId 
   */
  def endChannel(callId: String, channelId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def getCallsList(page: Option[Int] = None, perPage: Option[Int] = None, from: Option[Int] = None, to: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[CallListItem]] =
   ...
   * @param channelId 
   */
  def holdChannel(callId: String, channelId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   */
  def merge(callId: String, secCallId: String, agentId: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param channelId 
   */
  def muteChannel(callId: String, channelId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param callId 
   */
  def stopRing(callId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param channelId 
   */
  def unholChannel(callId: String, channelId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param channelId 
   */
  def unmuteChannel(callId: String, channelId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
