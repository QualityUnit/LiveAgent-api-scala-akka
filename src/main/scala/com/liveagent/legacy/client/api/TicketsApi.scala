...
class TicketsApi(baseUrl: String) {
   ...
   * @param ticket 
   */
  def createTicket(ticket: Option[TicketListItem] = None)(implicit apiKey: ApiKeyValue): ApiRequest[TicketInformation] =
   ...
   * @param ticketId 
   */
  def deleteTicket(ticketId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param ticketId 
   */
  def getTicket(ticketId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Ticket] =
   ...
   * @param attributeName 
   */
  def getTicketAttribute(ticketId: String, attributeName: String)(implicit apiKey: ApiKeyValue): ApiRequest[TicketAttribute] =
   ...
   */
  def getTicketHistory(perPage: Option[Int] = None, sortDir: Option[String] = None, filters: Option[String] = None, cursor: Option[String] = None, sortField: Option[String] = None, timezoneOffset: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[TicketHistory]] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getTicketHistoryCount(filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Count] =
   ...
   * @param ticketId 
   */
  def getTicketHistory_0(ticketId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[TicketHistory]] =
   ...
   */
  def getTicketMessageGroups(ticketId: String, includeQuotedMessages: Option[Boolean] = None, page: Option[Int] = None, perPage: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None, from: Option[Int] = None, to: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[MessageGroup]] =
   ...
   * @param ticketId 
   */
  def getTicketSla(ticketId: String)(implicit apiKey: ApiKeyValue): ApiRequest[TicketSla] =
   ...
   * @param filters Filters (json object {column:value, ...} or json array [[column,operator,value], ...])
   */
  def getTicketsList(page: Option[Int] = None, perPage: Option[Int] = None, from: Option[Int] = None, to: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Ticket]] =
   ...
   */
  def setTicketAttribute(ticketId: String, attributeName: String, value: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param userid 
   */
  def setTicketPostpone(ticketId: String, dateTime: String, userid: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param ticket 
   */
  def updateTicket(ticketId: String, ticket: Option[TicketUpdatable] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Ticket] =
