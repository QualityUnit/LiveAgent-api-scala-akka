...
class PredefinedAnswersApi(baseUrl: String) {
   ...
   */
  def createPredefinedAnswer(predefinedAnswer: Option[PredefinedAnswer] = None)(implicit apiKey: ApiKeyValue): ApiRequest[PredefinedAnswer] =
   ...
   */
  def deletePredefinedAnswer(predefinedAnswerId: String)(implicit apiKey: ApiKeyValue): ApiRequest[Any] =
   ...
   * @param predefinedAnswerId 
   */
  def getPredefinedAnswer(predefinedAnswerId: String)(implicit apiKey: ApiKeyValue): ApiRequest[PredefinedAnswer] =
   ...
   */
  def getPredefinedAnswersList(page: Option[Int] = None, perPage: Option[Int] = None, from: Option[Int] = None, to: Option[Int] = None, sortDir: Option[String] = None, sortField: Option[String] = None, filters: Option[String] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[PredefinedAnswer]] =
   ...
   * @param cannedMessage 
   */
  def updatePredefinedAnswer(predefinedAnswerId: String, cannedMessage: Option[PredefinedAnswer] = None)(implicit apiKey: ApiKeyValue): ApiRequest[PredefinedAnswer] =
