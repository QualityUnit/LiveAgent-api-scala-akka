...
object TicketListItemEnums {
  ...
  type DoNotSendMail = DoNotSendMail.Value
  type UseTemplate = UseTemplate.Value
  type IsHtmlMessage = IsHtmlMessage.Value
  ...
  object DoNotSendMail extends Enumeration {
    val `Y` = Value("Y")
    val `N` = Value("N")
  }

  object UseTemplate extends Enumeration {
    val `Y` = Value("Y")
    val `N` = Value("N")
  }

  object IsHtmlMessage extends Enumeration {
    val `Y` = Value("Y")
    val `N` = Value("N")
  }
